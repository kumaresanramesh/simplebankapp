 ...
 var enterSName = document.getElementById("enterSName").value;
  var findSenderBankAccount = enterSName + "BankBalance";
    ...
    if (enterAmount > enterSAmount) {
       ...
       var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the Mr/Ms ${enterSName} with Email-id ${enterSName}@email.com
  to Mr/Ms ${enterName} with Email-id ${enterName}@email.com on ${Date()}.`);
